...
extension FavoritesVC: ViewCodeProtocol {
    ...
    func setupConstraints() {
        if favorites.isEmpty {
            ...
            NSLayoutConstraint.activate([
                coverFlowView.view.topAnchor.constraint(
                    equalTo: view.safeAreaLayoutGuide.topAnchor
                ),
                coverFlowView.view.leadingAnchor.constraint(
                    equalTo: view.leadingAnchor
                ),
                coverFlowView.view.trailingAnchor.constraint(
                    equalTo: view.trailingAnchor
                ),
                coverFlowView.view.bottomAnchor.constraint(
                    equalTo: albumInfoStackView.topAnchor
                ),

                albumInfoStackView.leadingAnchor.constraint(
                    equalTo: view.leadingAnchor,
                    constant: 20
                ),
                albumInfoStackView.trailingAnchor.constraint(
                    equalTo: view.trailingAnchor,
                    constant: -20
                ),
                albumInfoStackView.bottomAnchor.constraint(
